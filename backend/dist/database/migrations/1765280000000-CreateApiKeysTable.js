...
exports.CreateApiKeysTable1765280000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateApiKeysTable1765280000000 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.createUniqueConstraint('api_keys', new typeorm_1.TableUnique({
        ...
        // Add foreign keys
        await queryRunner.createForeignKey('api_keys', new typeorm_1.TableForeignKey({
...
exports.CreateApiKeysTable1765280000000 = CreateApiKeysTable1765280000000;

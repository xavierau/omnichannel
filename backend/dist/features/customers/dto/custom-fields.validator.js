...
exports.MAX_CUSTOM_FIELDS_KEYS = exports.MAX_CUSTOM_FIELDS_DEPTH = exports.MAX_CUSTOM_FIELDS_SIZE = void 0;
exports.getObjectDepth = getObjectDepth;
exports.countKeys = countKeys;
exports.validatePrimitiveValues = validatePrimitiveValues;
exports.IsValidCustomFields = IsValidCustomFields;
 ...
 */
exports.MAX_CUSTOM_FIELDS_SIZE = 10 * 1024;
/**
 * Maximum nesting depth allowed in customFields.
 */
exports.MAX_CUSTOM_FIELDS_DEPTH = 3;
/**
 * Maximum number of keys allowed in customFields.
 */
exports.MAX_CUSTOM_FIELDS_KEYS = 50;
/**
...
function countKeys(obj) {
    ...
    return Object.keys(obj).length + Object.values(obj).reduce((count, v) => count + countKeys(v), 0);
}
/**
 ...
 */
function validatePrimitiveValues(obj) {
 ...
 */
function IsValidCustomFields(validationOptions) {
        ...
        (0, class_validator_1.registerDecorator)({
            ...
            validator: {
                ...
                validate(value, args) {
                    ...
                    if (size > exports.MAX_CUSTOM_FIELDS_SIZE) {
                        return false;
                    }
                    // Check depth
                    const depth = getObjectDepth(value);
                    if (depth > exports.MAX_CUSTOM_FIELDS_DEPTH) {
                        return false;
                    }
                    // Check key count
                    const keyCount = countKeys(value);
                    if (keyCount > exports.MAX_CUSTOM_FIELDS_KEYS) {
                        return false;
                    }
                ...
                defaultMessage() {
                    return `customFields must be an object with max ${exports.MAX_CUSTOM_FIELDS_SIZE} bytes, max ${exports.MAX_CUSTOM_FIELDS_DEPTH} levels of nesting, max ${exports.MAX_CUSTOM_FIELDS_KEYS} keys, and only primitive values`;
                },
            },
        });
    };

 ...
 * Webhook event types.
 */
export type WebhookEventType = 'status_update' | 'message_received' | 'error' | 'template_status_update';
/**
 * Template status values from Meta webhooks.
 */
export type MetaTemplateStatus = 'APPROVED' | 'REJECTED' | 'PENDING_DELETION' | 'DISABLED' | 'PENDING' | 'PAUSED' | 'IN_APPEAL' | 'FLAGGED' | 'LIMIT_EXCEEDED';
/**
 ...
 */
export type FreeformContentType = 'text' | 'image' | 'video' | 'audio' | 'document' | 'location' | 'contact' | 'sticker' | 'reaction' | 'interactive_list' | 'interactive_buttons';
/**

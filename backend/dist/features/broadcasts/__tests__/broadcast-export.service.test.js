...
describe('BroadcastExportService', () => {
    ...
    beforeEach(() => {
        ...
        exportService = new broadcast_export_service_1.BroadcastExportService(mockBroadcastRepository, mockGroupRepository);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('exportToCsv', () => {
        ...
        it('should limit export to 10000 records', async () => {
            ...
            expect(mockBroadcastRepository.findAll).toHaveBeenCalledWith(tenantId, expect.objectContaining({ limit: 10000 }));
        });
    ...
    describe('exportToExcel', () => {
        ...
        it('should pass through query options to repository', async () => {
            ...
            await exportService.exportToExcel(tenantId, {
                search: 'test',
                statuses: [enums_1.BroadcastStatus.COMPLETED],
                sortBy: 'name',
                sortOrder: 'asc',
            });
            expect(mockBroadcastRepository.findAll).toHaveBeenCalledWith(tenantId, expect.objectContaining({
                search: 'test',
                statuses: [enums_1.BroadcastStatus.COMPLETED],
                sortBy: 'name',
                sortOrder: 'asc',

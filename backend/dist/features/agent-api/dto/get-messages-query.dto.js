...
exports.AgentGetMessagesQueryDto = void 0;
 ...
 */
class AgentGetMessagesQueryDto {
    page = 1;
    limit = 50;
}
exports.AgentGetMessagesQueryDto = AgentGetMessagesQueryDto;
__decorate([
...
], AgentGetMessagesQueryDto.prototype, "page", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
    ...
    __metadata("design:type", Number)
], AgentGetMessagesQueryDto.prototype, "limit", void 0);

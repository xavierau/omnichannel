...
export class SeedChannelsAndProviders1733500001000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const whatsappId = channels.find((c: { id: string; code: string }) => c.code === 'whatsapp')
      .id;
    const smsId = channels.find((c: { id: string; code: string }) => c.code === 'sms').id;

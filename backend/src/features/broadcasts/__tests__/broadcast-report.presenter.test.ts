import { toBroadcastReportResponse } from '../broadcast-report.presenter';
...
describe('toBroadcastReportResponse', () => {
  ...
  describe('Basic fields', () => {
    it('should include basic broadcast information', () => {
      ...
      const report = toBroadcastReportResponse(broadcast);

      expect(report.id).toBe('broadcast-1');
      expect(report.name).toBe('Test Broadcast');
      expect(report.status).toBe(BroadcastStatus.COMPLETED);
  ...
  describe('Status-specific behavior', () => {
    it('should handle DRAFT status with no metrics', () => {
      ...
      expect(report.status).toBe(BroadcastStatus.DRAFT);
    ...
    it('should handle SENDING status with partial metrics', () => {
      ...
      expect(report.status).toBe(BroadcastStatus.SENDING);
    ...
    it('should handle FAILED status', () => {
      ...
      expect(report.status).toBe(BroadcastStatus.FAILED);
    ...
    it('should handle CANCELLED status', () => {
      ...
      expect(report.status).toBe(BroadcastStatus.CANCELLED);
    });
    ...
    it('should handle PAUSED status', () => {
      ...
      expect(report.status).toBe(BroadcastStatus.PAUSED);
